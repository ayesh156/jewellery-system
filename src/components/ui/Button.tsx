    ...
    return (
      <button
        className={cn(
          ...
          // Variants
          {
            'bg-slate-800 text-white hover:bg-slate-700 focus:ring-slate-500': variant === 'default',
            ...
            'border border-slate-600 bg-transparent text-slate-300 hover:bg-slate-800 focus:ring-slate-500': variant === 'outline',
